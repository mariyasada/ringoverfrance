export const productReducer = (state, action) => {
  switch (action.type) {
    ...
    case "UNSET_TYPE":
      return {
        ...state,
        sortByType: state.sortByType.filter((type) => type !== action.payload),
      };
    ...
    case "SET_TEMPLATE":
      return {
        ...state,
        sortByTemplate: [...state.sortByTemplate, action.payload],
      };
    ...
    case "UNSET_PRICE":
      return {
        ...
        sortByCost: state.sortByCost.filter(
          (cost) =>
            cost.labelName !== action.payload.labelName ||
            cost.minValue !== action.payload.minValue ||
            cost.maxValue !== action.payload.maxValue
        ),
      };
